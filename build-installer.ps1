...
Write-Host "Publishing RemoteLAN win-x64 binaries..." -ForegroundColor Cyan
dotnet publish src/RemoteLAN/RemoteLAN.csproj -c Release -r win-x64 --self-contained false -o bin/publish/
